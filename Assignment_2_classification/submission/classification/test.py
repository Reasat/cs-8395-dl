...
parser.add_argument('filepath', help='project directory')
parser.add_argument('--encoder',help='encoder',default='dpn92')
parser.add_argument('--batchSize', help='batch size', type=int, default=32)
parser.add_argument('--load_from', help='filepath to load model', default=r'..\model_weight\2020-02-10-22-06-20_dpn92_best.pt')
