...
from models import DPN92, DPN68, ResNet18
...
parser.add_argument('--dir_lf', help='directory large fileIDs',default=r'E:\Data\cs-8395-dl')
...
parser.add_argument('--bottleneckFeatures', help='bottleneck the encoder Features', type=int, default=0)
