...
loader_train = DataLoader(Dataset_train, sampler=BalancedBatchSampler(Dataset_train, labels_train_cat, shuffle=True), batch_size=BATCH_SIZE)
...
for epoch in epoch_range:
    ...
    print('recall_macro_valid: {:4f}'.format(recall_macro))
