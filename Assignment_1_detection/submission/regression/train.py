...
if args.encoder == 'resnet18':
    model = ResNet18_conv_fc(pretrained=True, bottleneckFeatures=args.bottleneckFeatures).to(device)
if args.encoder == 'resnet8':
    model = ResNet8_conv_fc(pretrained=True, bottleneckFeatures=args.bottleneckFeatures).to(device)
if args.encoder == 'resnet12':
    model = ResNet12_conv_fc(pretrained=True, bottleneckFeatures=args.bottleneckFeatures).to(device)
